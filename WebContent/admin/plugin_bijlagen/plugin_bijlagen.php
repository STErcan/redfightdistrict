...
<table border="0" cellspacing="0" cellpadding="4" class="form algemeen">
	...
	<tr>
		<td style="width:340px; vertical-align:top;">
            Hieronder staan de bijlagen voor deze pagina.<br />
            Klik op de knop rechts om nieuwe bestanden te selecteren
        </td>
		<td style="vertical-align:top;">
            <form>
                <div id="Buttoncontainer" class="files"> <span id="spanButtonPlaceHolder">hier zou een knop moeten staan...</span> </div>
            </form>
		</td>
	</tr>
	<tr>
	...
	<tr class="sub_lijn">
      <td colspan="2">
        ...
        <script type="text/javascript" src="<?php echo $upload_dir['base']; ?>admin/js/swfupload/handlers_files.js"></script>
        ...
        $(document).ready(function(){
            ...
            var settings = {
				...
				upload_url: "<?php echo $upload_dir['base']; ?>admin/ajax/upload_files.php",	// Relative to the SWF file or absolute
                post_params: {'tabelnaam':'<?php echo $module_naam; ?>', 'mijn_id':'<?php echo $mijn_id; ?>', 'dir':'<?php echo $upload_dir['base_bijlagen']; ?>'},
        
                // File Upload Settings
                file_size_limit: file_size,
                file_types: "*.*",
                file_types_description: "Bestanden",
                file_upload_limit: 0,
                file_queue_limit: 20,
				...
				button_text: '<span class="button">Selecteer bestanden\'s <span class="buttonSmall">(Max. '+file_size+')</span></span>',
		...
		function load_files() {
			$.ajax({
				url: 'plugin_bijlagen/plugin_bijlagen_show.php',
